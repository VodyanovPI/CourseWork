...
\mbox{\texttt{ in}}  & {\em t\+\_\+ntp} & \mbox{\hyperlink{classNTP}{N\+TP}} метка времени, tp указатель на структуру timespec \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}[1]{Аргументы}
\mbox{\texttt{ out}}  & {\em t\+\_\+ntp} & \mbox{\hyperlink{classNTP}{N\+TP}} метка времени, tp указатель на структуру timespec \\
\hline
\end{DoxyParams}
